...
{\large
Software engineer with experience in the insurance and financial industry, with a track record of producing clean code, eliminating technical debt, and digging into complicated problems spanning multiple systems.
...
\begin{itemize}\itemsep \listsep  \small
    ...
    \resitem{Reengineered document management integration middleware based on Java EE/Apache Camel/Spring, focusing on a cleaner data model, cleaner APIs, 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \ressubheading{Penguicon}{Southfield MI}{Head of Logistics}{December 2015 -- present}
    \begin{itemize} \itemsep \listsep \small
...
\begin{itemize} \itemsep 2\listsep
    ...
    \item {\bf Programming languages:} Java; Python; Gosu; JavaScript; shell script; C$\sharp$
    \item {\bf Frameworks:} Apache Camel; Spring Web Services; Express
    \item {\bf Databases:} MS SQL Server; Hibernate
    \item {\bf Operating systems:} Linux (desktop \& embedded); Windows
    \item {\bf Infrastructure/Platform:} Travis-CI; Jenkins; Docker
    \item {\bf Networking:} Ubiquiti EdgeOS and UniFi platform; TCP/IP
    \item {\bf Workflow:} git; GitHub; BitBucket; JIRA; shell scripting
