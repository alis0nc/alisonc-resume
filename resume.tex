...
\parbox{\textwidth}{\centering
    ...
    \ifdef{\PUBLIC}{\ifdef{\MONSTER}{\texttt{resm@alisonc.net}%
        }{\ifdef{\DICE}{\texttt{resd@alisonc.net}%
        }{\texttt{res@alisonc.net}%
    }}}{\texttt{hireme@alisonc.net}}~\textbullet~%
    \ifdef{\PUBLIC}{Email~for~phone~number}{+1~909~278~7753}~\textbullet~%
