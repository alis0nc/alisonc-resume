...
\textbf{{\Large Alison Chan}} & \textbf{Farmington Hills MI} & \textbf{{\small Last updated} 2017-09-25} \\
...
\begin{itemize}\small
    ...
    \resitem{Reengineered Java EE/Apache Camel/Spring integration code to be more cleanly designed and fault tolerant.}
    \resitem{Configured Guidewire ClaimCenter front end with vanilla JavaScript and Gosu code.}
    \resitem{Led design review, code review, and data model discussions.}
    \resitem{Troubleshooted integration errors, working closely with external vendors and other departments in the client organisation.}
