...
\textbf{{\Large Alison Chan}} & \textbf{Farmington Hills MI} & \textbf{{\small Last updated} 2017-06-22} \\
...
\begin{itemize}\small
    ...
    \resitem{In a production support role, worked with external vendors and other IT departments in the client organisation (e.\ g.\ Enterprise Content Management 
    	and Financial Systems) to debug integration issues with the claims system.}
    \resitem{Solved end user issues in production environment.}
