...
\vspace{8pt} 
Java programming experience; NetBeans IDE.
Experience with document preparation using \LaTeX.
Experience with Facebook page administration and WordPress blogs.
Experience with electronic instrumentation; oscilloscopes, function generators, etc.
