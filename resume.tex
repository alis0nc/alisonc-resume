...
\ifdef{\SHALEM}{\ressubheading{Fund for Equal Justice}{Detroit MI}{Assistant}{January 2018 -- present}
\begin{itemize}\itemsep \listsep \small
	\resitem{Implemented a mail merge document for donation acknowledgement letters.}
...
\begin{itemize}\itemsep \listsep  \small
	...
	\resitem{Communicated with customers and restaurants to assess pickup and delivery needs and inform of order status.}
...
\begin{itemize}\itemsep \listsep  \small
    ...
    \resitem{Reengineered document management integration middleware based on Java EE/Apache Camel/Spring, focusing on cleaner data model and APIs and better fault tolerance. This led to fewer system errors, improved performance, and easier troubleshooting.}
    ...
    \resitem{Troubleshooted integration errors, working closely with external vendors and other departments at A-O. Released data and code hotfixes to production.}
...
\begin{itemize} \itemsep \listsep \small
	...
	\resitem{Coordinated the transportation of convention property between storage and the convention venue, including scheduling load-in and load-out, determining volunteer staff needs, and directing volunteers during load-in and load-out.}
\end{itemize}
...
\begin{itemize} \itemsep 2\listsep
    ...
    \item {\bf Networking:} Ubiquiti EdgeOS and UniFi platform; TCP/IP; IPv6 dual-stack environments; PXE
