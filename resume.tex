...
\textbf{{\Large Alison Chan}} & \textbf{Farmington Hills MI} & \textbf{{\small Last updated} 2017-08-23} \\
...
\begin{itemize}\small
    ...
    \resitem{Reimplemented various integration points, leading to cleaner code and fewer errors.}
    \resitem{Led design review and code review discussions.}
